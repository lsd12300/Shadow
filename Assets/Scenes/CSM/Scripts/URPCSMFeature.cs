...
public class URPCSMFeature : ScriptableRendererFeature
{
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public CustomRenderPass(RenderPassSettings settings)
        {
            ...
            if (m_csm == null)
            {
                m_csm = new CSM(GameObject.Find("Directional Light").GetComponent<Light>(), GameObject.Find("Main Camera").GetComponent<Camera>(),
                    m_cascadeCount, m_cascadeSplitType);
        ...
        {
            cmd.GetTemporaryRT(m_depthRT.id, m_perLevelTextureSize * m_cascadeCount / 2, m_perLevelTextureSize * 2);
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //Debug.LogError($"{camData.GetViewMatrix()},  {camData.GetProjectionMatrix()}");
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                for (int i = 0; i < fs.Length; i++)
                {
                    ...
                    {
                        var horizontalCount = m_cascadeCount / 2;
